...
df_racer = pd.read_csv('streamlit_template/streamlit_template/data/racer_stats.csv')
...
with left_column_2:
    st.image(f"streamlit_template/streamlit_template/images/{chosen}.png", width=200)
...
if st.checkbox('Show All Racers'):
    st.bar_chart(df_racer, x='Character', y=['Speed','Acceleration', 'Weight','Handling','Mini-Turbo','Traction/Grip'])